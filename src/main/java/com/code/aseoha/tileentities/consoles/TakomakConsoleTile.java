...
public class TakomakConsoleTile extends ConsoleTile {
...
//        return RENDER_BOX.getCenter(this.getPos());
    ...
    public TakomakConsoleTile() {
        this(AseohaTiles.console_takomak.get());
        this.registerControlEntry(ControlRegistry.MONITOR.get());
    }

    public TakomakConsoleTile(TileEntityType<?> type) {
        super(type);
//       this.registerControlEntry(ControlRegistry.MONITOR.get());
      //Done
       ...
       //Done
       this.controlOverrides.put(IncModControl.class, new ControlOverride(new Vector3d(0, 0.75, -0.4),EntitySize.scalable(0.25F, 0.075F)));
        //Done
       ...
       //Done
       this.controlOverrides.put(YControl.class, new ControlOverride(new Vector3d(0.03, 0.55, -0.7),EntitySize.scalable(0.12F, 0.1F)));
       //Done
