...
public class SutekhTardisTile extends ExteriorTile {

    public static final AxisAlignedBB RENDER = new AxisAlignedBB(-1, -1, -1, 2, 2, 2);
    public SutekhTardisTile() {
        super(AseohaTiles.EXTERIOR_SUTEKH_TARDIS.get());
        this.setVariants(TextureVariants.WHITTAKER);
    }
