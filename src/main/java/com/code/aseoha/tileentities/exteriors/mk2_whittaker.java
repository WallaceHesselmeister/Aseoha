...
public class mk2_whittaker extends ExteriorTile {

    public static final AxisAlignedBB RENDER = new AxisAlignedBB(-1, -1, -1, 2, 2, 2);
    public mk2_whittaker() {
        super(AseohaTiles.EXTERIOR_MK2_WHITTAKER.get());
        this.setVariants(TextureVariants.MK2_WHITTAKER);
    }
