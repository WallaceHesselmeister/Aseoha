...
//    public static List<RegistryKey<World>> TARDIS_DIMENSIONS = new ArrayList<RegistryKey<World>>();
    ...
    public static final RegistryKey<World> VORTEX_DIM = RegistryKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(aseoha.MODID, "vortex"));
    ...
    public static class DimensionTypes {
        ...
        public static final RegistryKey<DimensionType> VORTEX_TYPE = RegistryKey.create(Registry.DIMENSION_TYPE_REGISTRY, new ResourceLocation(aseoha.MODID, "vortex"));
    }
