...
import com.code.aseoha.networking.Packets.c2s.SetCoordsPacketC2S;
    ...
    protected void init() {
        ...
        this.setCoord = this.createButton(this.parent.getMinX(), this.parent.getMinY(), this.coord_set, (but) -> {
            if (this.console != null) {
                ...
                Networking.sendToServer(new SetCoordsPacketC2S(this.console, this.Axis, Integer.parseInt(this.coord.getValue())));
            }
        });
