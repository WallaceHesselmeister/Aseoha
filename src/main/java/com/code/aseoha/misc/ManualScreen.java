...
import com.code.aseoha.misc.Chapter;
...
public class ManualScreen extends Screen {
    ...
    private void read(){
        ...
        try{
            ...
            Tardis.LOGGER.error("Could not find Manual resources for locale: {}, reverting to contents for locale {}", Minecraft.getInstance().getLanguageManager().getSelected().getCode(), TardisConstants.ENGLISH_US_LOCALE);
