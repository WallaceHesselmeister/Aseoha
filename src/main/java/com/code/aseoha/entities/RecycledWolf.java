...
public class RecycledWolf extends TameableEntity implements IAngerable {
    private static final DataParameter<Boolean> DATA_INTERESTED_ID = EntityDataManager.defineId(RecycledWolf.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> DATA_COLLAR_COLOR = EntityDataManager.defineId(RecycledWolf.class, DataSerializers.INT);
    private static final DataParameter<Integer> DATA_REMAINING_ANGER_TIME = EntityDataManager.defineId(RecycledWolf.class, DataSerializers.INT);
    ...
    public RecycledWolf(EntityType<? extends RecycledWolf> p_i50240_1_, World p_i50240_2_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new RecycledWolf.AvoidEntityGoal<>(this, LlamaEntity.class, 24.0F, 1.5D, 1.5D));
...
//    }
    ...
    /**
     * By default this uses a ModEntityTypes.K9.
     * @param world The World
     * @param ageableEntity The Ageable Entity
     * @return Returns the entity to spawn
     */
    public RecycledWolf getBreedOffspring(ServerWorld world, AgeableEntity ageableEntity) {
        RecycledWolf entity = ModEntityTypes.K9.get().create(world);
    ...
    public boolean canMate(AnimalEntity p_70878_1_) {
        if (p_70878_1_ == this) {
            ...
            return false;
        } else if (!(p_70878_1_ instanceof RecycledWolf)) {
            return false;
        } else {
            RecycledWolf RecycledWolf = (RecycledWolf)p_70878_1_;
            if (!RecycledWolf.isTame()) {
                return false;
            } else if (RecycledWolf.isInSittingPose()) {
                return false;
            } else {
                return this.isInLove() && RecycledWolf.isInLove();
            }
        }
    }
    ...
    public boolean wantsToAttack(LivingEntity p_142018_1_, LivingEntity p_142018_2_) {
        if (!(p_142018_1_ instanceof CreeperEntity) && !(p_142018_1_ instanceof GhastEntity)) {
            if (p_142018_1_ instanceof RecycledWolf) {
                RecycledWolf RecycledWolf = (RecycledWolf)p_142018_1_;
                return !RecycledWolf.isTame() || RecycledWolf.getOwner() != p_142018_2_;
    ...
    class AvoidEntityGoal<T extends LivingEntity> extends net.minecraft.entity.ai.goal.AvoidEntityGoal<T> {
        ...
        public AvoidEntityGoal(RecycledWolf p_i47251_2_, Class<T> p_i47251_3_, float p_i47251_4_, double p_i47251_5_, double p_i47251_7_) {
        ...
        private boolean avoidLlama(LlamaEntity p_190854_1_) {
            return p_190854_1_.getStrength() >= RecycledWolf.this.random.nextInt(5);
        }
