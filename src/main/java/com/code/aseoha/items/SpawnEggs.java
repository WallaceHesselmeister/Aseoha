...
public class SpawnEggs extends SpawnEggItem {
    protected static final List<SpawnEggs> UNADDED_EGGS = new ArrayList<>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public SpawnEggs(final RegistryObject<? extends EntityType<?>> entityTypeSupplier,
    ...
    public static void initSpawnEggs() {
        ...
        DefaultDispenseItemBehavior dispenseItemBehavior = new DefaultDispenseItemBehavior() {
            //@Override
            private ItemStack dispenseStack(IBlockSource source, ItemStack stack){
