...
public class RoadStructure extends Structure {
        ...
        public static final Codec<RoadStructure> CODEC = RecordCodecBuilder.<RoadStructure>mapCodec(instance ->
                instance.group(RoadStructure.configCodecBuilder(instance),
        ...
        public RoadStructure(Structure.Config config,
        ...
        public StructureType<?> getType() {
            return Structures.ROAD_STRUCTURE; // Helps the game know how to turn this structure back to json to save to chunks
        }
    }
