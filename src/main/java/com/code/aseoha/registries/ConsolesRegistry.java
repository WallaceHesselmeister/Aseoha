...
public class ConsolesRegistry {
    ...
    public static final RegistryObject<com.code.aseoha.misc.Console> CUSTARD =
            CONSOLES.register("custard", () -> new com.code.aseoha.misc.Console(() -> AseohaBlocks.console_custard.get().defaultBlockState(), "custardconsole"));

    public static final RegistryObject<com.code.aseoha.misc.Console> BATTLE =
            CONSOLES.register("battle", () -> new com.code.aseoha.misc.Console(() -> AseohaBlocks.console_battle.get().defaultBlockState(), "battleconsole"));

    public static final RegistryObject<com.code.aseoha.misc.Console> BRACKOLIN =
            CONSOLES.register("brackolin", ()-> new com.code.aseoha.misc.Console(() -> AseohaBlocks.console_brackolin.get().defaultBlockState(),"brackolinconsole"));

    public static final RegistryObject<com.code.aseoha.misc.Console> BLUEMARBLE =
            CONSOLES.register("bluemarble", ()-> new com.code.aseoha.misc.Console(() -> AseohaBlocks.console_bluemarble.get().defaultBlockState(),"bluemarble"));

    public static final RegistryObject<com.code.aseoha.misc.Console> HARTNELL =
            CONSOLES.register("hartnell", ()-> new com.code.aseoha.misc.Console(() -> AseohaBlocks.console_hartnell.get().defaultBlockState(),"hartnell"));
