...
//    };
    ...
    private ManualScreen.IBookInfo bookAccess;
    ...
    public ManualScreen(ManualScreen.IBookInfo p_i51098_1_) {
        this(p_i51098_1_, true);
    }


    private ManualScreen(ManualScreen.IBookInfo p_i51099_1_, boolean p_i51099_2_) {
        super(NarratorChatListener.NO_TITLE);
        this.bookAccess = p_i51099_1_;
        this.playTurnSound = p_i51099_2_;
    }

    public void setBookAccess(ManualScreen.IBookInfo p_214155_1_) {
    ...
    public interface IBookInfo {
        ...
        static ManualScreen.IBookInfo fromItem(ItemStack p_216917_0_) {
            Item item = p_216917_0_.getItem();
            if (item == ModItems.ASEOHA_MANUAL.get()) {
                return new ManualScreen.WrittenBookInfo(p_216917_0_);
            } else {
    ...
    public static class UnwrittenBookInfo implements ManualScreen.IBookInfo {
        ...
        private static List<String> readPages(ItemStack p_216919_0_) {
            ...
            return (List<String>)(compoundnbt != null ? ManualScreen.convertPages(compoundnbt) : ImmutableList.of());
        }
    ...
    public static class WrittenBookInfo implements ManualScreen.IBookInfo {
        ...
        private static List<String> readPages(ItemStack p_216921_0_) {
            ...
            return (List<String>)(compoundnbt != null && WrittenBookItem.makeSureTagIsValid(compoundnbt) ? ManualScreen.convertPages(compoundnbt) : ImmutableList.of(ITextComponent.Serializer.toJson((new TranslationTextComponent("book.invalid.tag")).withStyle(TextFormatting.DARK_RED))));
        }
        ...
        public ITextProperties getPageRaw(int p_230456_1_) {
            ...
            try {
                ...
                aseoha.LOGGER.info("MANUAL SCREEN EXCEPTION!");
            }
