...
public class mk_two_smith extends ExteriorModel {
	...
	public mk_two_smith() {
		...
		bone.texOffs(42, 85).addBox(-14.0F, -49.0F, -14.0F, 4.0F, 46.0F, 4.0F, 0.0F, false);
		bone.texOffs(42, 85).addBox(-14.0F, -49.0F, 10.0F, 4.0F, 46.0F, 4.0F, 0.0F, false);
		bone.texOffs(42, 85).addBox(10.0F, -49.0F, 10.0F, 4.0F, 46.0F, 4.0F, 0.0F, false);
		bone.texOffs(42, 85).addBox(10.0F, -49.0F, -14.0F, 4.0F, 46.0F, 4.0F, 0.0F, false);
		bone.texOffs(102, 129).addBox(-10.0F, -43.0F, -13.0F, 1.0F, 40.0F, 1.0F, 0.0F, false);
		bone.texOffs(0, 85).addBox(-13.0F, -43.0F, -10.0F, 1.0F, 40.0F, 20.0F, 0.0F, false);
		bone.texOffs(96, 33).addBox(-10.0F, -43.0F, 12.0F, 20.0F, 40.0F, 1.0F, 0.0F, false);
		bone.texOffs(68, 65).addBox(12.0F, -43.0F, -10.0F, 1.0F, 40.0F, 20.0F, 0.0F, false);
		bone.texOffs(98, 129).addBox(9.0F, -43.0F, -13.0F, 1.0F, 40.0F, 1.0F, 0.0F, false);
		bone.texOffs(90, 28).addBox(-9.0F, -43.0F, -13.0F, 18.0F, 1.0F, 1.0F, 0.0F, false);
		bone.texOffs(110, 81).addBox(-12.0F, -47.0F, -15.0F, 24.0F, 4.0F, 3.0F, 0.0F, false);
		bone.texOffs(86, 101).addBox(-15.0F, -47.0F, -12.0F, 3.0F, 4.0F, 24.0F, 0.0F, false);
		bone.texOffs(90, 74).addBox(-12.0F, -47.0F, 12.0F, 24.0F, 4.0F, 3.0F, 0.0F, false);
		bone.texOffs(90, 0).addBox(12.0F, -47.0F, -12.0F, 3.0F, 4.0F, 24.0F, 0.0F, false);
		...
		bone.texOffs(0, 0).addBox(-3.0F, -54.0F, -3.0F, 6.0F, 1.0F, 6.0F, 0.0F, false);
		bone.texOffs(0, 22).addBox(-1.5F, -58.0F, -1.5F, 3.0F, 4.0F, 3.0F, 0.0F, false);
		bone.texOffs(15, 7).addBox(-1.5F, -57.0F, -1.5F, 3.0F, 2.0F, 3.0F, 0.2F, false);
		bone.texOffs(0, 7).addBox(-2.5F, -59.0F, -2.5F, 5.0F, 1.0F, 5.0F, 0.0F, false);
		bone.texOffs(7, 13).addBox(-1.0F, -60.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		cube_r1 = new ModelRenderer(this);
		cube_r1.setPos(0.0F, -45.0F, 0.0F);
		bone.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.0F, 0.7854F, 0.0F);
		cube_r1.texOffs(0, 13).addBox(-0.5F, -13.0F, -2.5F, 1.0F, 4.0F, 5.0F, 0.0F, false);

		cube_r2 = new ModelRenderer(this);
		cube_r2.setPos(0.0F, -45.0F, 0.0F);
		bone.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.0F, -0.7854F, 0.0F);
		cube_r2.texOffs(12, 13).addBox(-0.5F, -13.0F, -2.5F, 1.0F, 4.0F, 5.0F, 0.0F, false);

		LeftDoor = new ModelRenderer(this);
		LeftDoor.setPos(-9.0F, -22.5F, -12.0F);
		bone.addChild(LeftDoor);
		LeftDoor.texOffs(78, 129).addBox(0.0F, -19.5F, -1.0F, 9.0F, 39.0F, 1.0F, 0.0F, false);
		LeftDoor.texOffs(58, 122).addBox(7.0F, -5.0F, -2.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);

		RightDoor = new ModelRenderer(this);
		RightDoor.setPos(9.0F, -22.5F, -12.0F);
		bone.addChild(RightDoor);
		RightDoor.texOffs(58, 125).addBox(-9.0F, -19.5F, -1.0F, 9.0F, 39.0F, 1.0F, 0.0F, false);
		RightDoor.texOffs(64, 121).addBox(-9.0F, -5.0F, -2.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
	}
