...
public class ScreenFrameModel extends EntityModel<Entity> {
	private final ModelRenderer Shape1;
	private final ModelRenderer Shape2;
	private final ModelRenderer Shape3;
	private final ModelRenderer Shape4;

	public ScreenFrameModel() {
		texWidth = 32;
		texHeight = 16;

		Shape1 = new ModelRenderer(this);
		Shape1.setPos(-1.0F, 0.0F, 9.0F);
		Shape1.texOffs(0, 11).addBox(0.0F, 0.0F, 0.0F, 9.0F, 2.0F, 1.0F, 0.0F, false);

		Shape2 = new ModelRenderer(this);
		Shape2.setPos(-1.0F, 0.0F, 0.0F);
		Shape2.texOffs(0, 0).addBox(0.0F, 0.0F, 0.0F, 1.0F, 2.0F, 9.0F, 0.0F, false);

		Shape3 = new ModelRenderer(this);
		Shape3.setPos(8.0F, 0.0F, 1.0F);
		Shape3.texOffs(0, 0).addBox(0.0F, 0.0F, 0.0F, 1.0F, 2.0F, 9.0F, 0.0F, false);

		Shape4 = new ModelRenderer(this);
		Shape4.setPos(0.0F, 0.0F, 0.0F);
		Shape4.texOffs(0, 11).addBox(0.0F, 0.0F, 0.0F, 9.0F, 2.0F, 1.0F, 0.0F, false);
	}
