...
public class SchemaDisplayModel extends EntityModel<Entity> {
	...
	public SchemaDisplayModel() {
		texWidth = 128;
		texHeight = 32;

		Shape1 = new ModelRenderer(this);
		Shape1.setPos(0.0F, 0.0F, 0.0F);
		Shape1.texOffs(0, 0).addBox(0.0F, 0.0F, 0.0F, 32.0F, 4.0F, 1.0F, 0.0F, false);

		Shape2 = new ModelRenderer(this);
		Shape2.setPos(0.0F, -1.0F, -1.0F);
		Shape2.texOffs(0, 5).addBox(0.0F, 0.0F, 0.0F, 33.0F, 1.0F, 2.0F, 0.0F, false);

		Shape3 = new ModelRenderer(this);
		Shape3.setPos(32.0F, 0.0F, -1.0F);
		Shape3.texOffs(70, 0).addBox(0.0F, 0.0F, 0.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);

		Shape4 = new ModelRenderer(this);
		Shape4.setPos(-1.0F, -1.0F, -1.0F);
		Shape4.texOffs(76, 0).addBox(0.0F, 0.0F, 0.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);

		Shape5 = new ModelRenderer(this);
		Shape5.setPos(-1.0F, 4.0F, -1.0F);
		Shape5.texOffs(0, 8).addBox(0.0F, 0.0F, 0.0F, 33.0F, 1.0F, 2.0F, 0.0F, false);
	}
