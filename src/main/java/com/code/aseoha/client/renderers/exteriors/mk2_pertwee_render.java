...
import com.code.aseoha.client.models.exteriors.mk_two_pertwee;
import com.code.aseoha.tileentities.exteriors.AlfieHudolinTile;
import com.code.aseoha.tileentities.exteriors.mk2_pertwee;
...
public class mk2_pertwee_render extends ExteriorRenderer<mk2_pertwee> {
    ...
    public mk2_pertwee_render(TileEntityRendererDispatcher rendererDispatcherIn) {
        super(rendererDispatcherIn);
    }

    public void renderExterior(mk2_pertwee tile, float v, MatrixStack matrixStack, IRenderTypeBuffer bufferIn, int i, int i1, float v1) {
