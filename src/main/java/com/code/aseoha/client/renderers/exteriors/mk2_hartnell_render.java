...
import com.code.aseoha.client.models.exteriors.mk_two_hartnell;
import com.code.aseoha.tileentities.exteriors.AlfieHudolinTile;
import com.code.aseoha.tileentities.exteriors.mk2_hartnell;
...
public class mk2_hartnell_render extends ExteriorRenderer<mk2_hartnell> {
    ...
    public mk2_hartnell_render(TileEntityRendererDispatcher rendererDispatcherIn) {
        super(rendererDispatcherIn);
    }

    public void renderExterior(mk2_hartnell tile, float v, MatrixStack matrixStack, IRenderTypeBuffer bufferIn, int i, int i1, float v1) {
