...
@OnlyIn(Dist.CLIENT)
public class BasicSkyProperty extends DimensionRenderInfo {
    private final float[] sunriseCol = new float[4];

    public BasicSkyProperty() {
        super(240F, true, FogType.NONE, false, true);
        this.setSkyRenderHandler(new BasicSkyRenderer());
    }
