...
public class SurfaceBuilder {
    ...
    private static < S extends net.minecraft.world.gen.surfacebuilders.SurfaceBuilder< ? >> RegistryObject< S > createSurfaceBuilder(String name, Supplier< ? extends S > surfaceBuilder) {
    ...
    private static < SC extends ISurfaceBuilderConfig > ConfiguredSurfaceBuilder< SC > registerConfiguredSurfaceBuilder(String name, ConfiguredSurfaceBuilder< SC > configuredSurfaceBuilder) {
        return WorldGenRegistries.register(WorldGenRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(aseoha.MODID, name), configuredSurfaceBuilder);
    }
    ...
    public static class SurfaceBuilders {
        ...
        public static final net.minecraft.world.gen.surfacebuilders.SurfaceBuilder< SurfaceBuilderConfig > DEATH_ZONE_BUILDER_INSTANCE = new DeathZoneSurfaceBuilder(SurfaceBuilderConfig.CODEC);
        public static final RegistryObject<net.minecraft.world.gen.surfacebuilders.SurfaceBuilder< SurfaceBuilderConfig >> DEATH_ZONE_BUILDER = createSurfaceBuilder("death_zone", () -> DEATH_ZONE_BUILDER_INSTANCE);
