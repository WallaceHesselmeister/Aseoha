...
public class RTD9ExteriorModel<T extends ExteriorTile> extends BasicTileHierarchicalModel<T> implements IExteriorModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(aseoha.MODID, "rtd9exteriormodel"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Shell = partdefinition.addOrReplaceChild("Shell", CubeListBuilder.create().texOffs(0, 58).addBox(-26.0F, -5.0F, -26.0F, 52.0F, 1.0F, 52.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).mirror().addBox(-27.0F, -4.0F, -27.0F, 27.0F, 0.0F, 54.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 0).mirror().addBox(0.0F, -4.0F, -27.0F, 27.0F, 0.0F, 54.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(54, 0).mirror().addBox(0.0F, 0.0F, -27.0F, 27.0F, 0.0F, 54.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(108, 54).addBox(-27.0F, -4.0F, -27.0F, 54.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition boti_r1 = Shell.addOrReplaceChild("boti_r1", CubeListBuilder.create().texOffs(294, 196).addBox(-18.0F, -39.5F, 0.0F, 35.0F, 79.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -44.25F, 0.0F, 0.0F, 3.1416F, 0.0F));
        ...
        PartDefinition Emmisive = partdefinition.addOrReplaceChild("Emmisive", CubeListBuilder.create().texOffs(1, 251).addBox(-22.6F, -77.0F, 2.0F, 1.0F, 15.0F, 13.0F, new CubeDeformation(0.0F))
                .texOffs(1, 251).addBox(-22.6F, -77.0F, -15.0F, 1.0F, 15.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition cube_r9 = Emmisive.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(0, 263).addBox(2.0F, -7.5F, -0.5F, 13.0F, 15.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r10 = Emmisive.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(1, 251).addBox(-0.5F, -7.5F, -6.5F, 1.0F, 15.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(22.1F, -69.5F, -8.5F, 0.0F, 3.1416F, 0.0F));

        PartDefinition cube_r11 = Emmisive.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(1, 251).addBox(-0.5F, -7.5F, -6.5F, 1.0F, 15.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(22.1F, -69.5F, 8.5F, 0.0F, 3.1416F, 0.0F));

        PartDefinition cube_r12 = Emmisive.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(28, 17).addBox(-2.0F, -103.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.0F, -0.7854F, 0.0F));
        ...
        PartDefinition LeftDoor = partdefinition.addOrReplaceChild("LeftDoor", CubeListBuilder.create(), PartPose.offset(-16.9167F, -18.2308F, -23.0167F));
        ...
        PartDefinition phone = LeftNonEmmisives.addOrReplaceChild("phone", CubeListBuilder.create().texOffs(0, 90).addBox(-0.0833F, -15.0192F, 0.0167F, 13.0F, 15.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(157, 76).addBox(1.9167F, -13.0192F, 0.4167F, 9.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(178, 76).addBox(1.9167F, -11.0192F, 1.4167F, 9.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(178, 76).addBox(1.9167F, -11.0192F, 2.4167F, 9.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(186, 86).addBox(3.9167F, -10.0192F, 3.4167F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(186, 86).addBox(6.9167F, -10.0192F, 3.4167F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r13 = phone.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(28, 0).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(14.4167F, 0.9808F, 1.4167F, 3.1416F, 0.0F, 1.5708F));

        PartDefinition cube_r14 = phone.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(28, 0).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(14.4167F, 1.9808F, 1.4167F, 3.1416F, 0.0F, 1.5708F));

        PartDefinition cube_r15 = phone.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(28, 0).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(28, 0).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(14.4167F, 1.9808F, 1.4167F, 0.0F, 3.1416F, 0.0F));

        PartDefinition cube_r16 = phone.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(177, 86).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.9167F, -11.5192F, 2.4167F, 0.0F, -0.7854F, 0.0F));

        PartDefinition cube_r17 = phone.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(177, 86).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.9167F, -11.5192F, 2.4167F, 0.0F, -0.7854F, 0.0F));

        PartDefinition cube_r18 = phone.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(186, 90).addBox(-1.5F, -1.5F, -0.5F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.4167F, -5.5192F, 3.9167F, 0.0F, 0.0F, 0.7854F));
        ...
        PartDefinition RightNonEmmisive = RightDoor.addOrReplaceChild("RightNonEmmisive", CubeListBuilder.create().texOffs(0, 284).addBox(-16.9F, -37.8333F, -1.95F, 2.0F, 75.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(222, 281).addBox(-1.9F, -37.8333F, -1.95F, 2.0F, 75.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(132, 119).addBox(-14.9F, 34.1667F, -1.95F, 13.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 58).addBox(-14.9F, 19.1667F, -1.45F, 13.0F, 15.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(132, 115).addBox(-14.9F, 16.1667F, -1.95F, 13.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 32).addBox(-14.9F, 1.1667F, -1.45F, 13.0F, 15.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(132, 111).addBox(-14.9F, -1.8333F, -1.95F, 13.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 16).addBox(-14.9F, -16.8333F, -1.45F, 13.0F, 15.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 106).addBox(-14.9F, -19.8333F, -1.95F, 13.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 106).addBox(-14.9F, -37.8333F, -1.95F, 13.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(290, 289).addBox(-15.9F, -37.8333F, -1.05F, 1.0F, 75.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(290, 292).addBox(-16.9F, -37.8333F, -1.05F, 1.0F, 75.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(290, 292).addBox(-1.9F, -37.8333F, -1.05F, 1.0F, 75.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(290, 289).addBox(-0.9F, -37.8333F, -1.05F, 1.0F, 75.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(340, 35).mirror().addBox(-14.9F, -37.8333F, -1.05F, 13.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(340, 35).mirror().addBox(-14.9F, 34.1667F, -1.05F, 13.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(340, 35).mirror().addBox(-14.9F, -19.8333F, -1.05F, 13.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(340, 35).mirror().addBox(-14.9F, 16.1667F, -1.05F, 13.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(340, 43).addBox(-14.9F, -1.8333F, -1.05F, 13.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 74).addBox(-14.9F, -34.8333F, -1.45F, 13.0F, 15.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(28, 6).addBox(-15.9F, -11.3333F, -2.95F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(28, 6).addBox(-15.9F, -6.3333F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(28, 6).addBox(-15.9F, -12.3333F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition cube_r19 = RightNonEmmisive.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(28, 6).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.3F, -0.8333F, 0.0F, 3.1416F, 0.0F, -1.5708F));

        PartDefinition cube_r20 = RightNonEmmisive.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(28, 6).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.4F, -0.3333F, -0.25F, 3.1416F, 0.0F, -1.5708F));

        PartDefinition cube_r21 = RightNonEmmisive.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(28, 6).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.3F, 0.1667F, 0.0F, 3.1416F, 0.0F, -1.5708F));

        PartDefinition cube_r22 = RightNonEmmisive.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(28, 6).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-15.3F, 0.1667F, 0.0F, 3.1416F, 0.0F, -1.5708F));

        PartDefinition cube_r23 = RightNonEmmisive.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(28, 6).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-15.3F, -0.8333F, 0.0F, 3.1416F, 0.0F, -1.5708F));

        PartDefinition cube_r24 = RightNonEmmisive.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(28, 6).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-15.55F, -0.3333F, 0.25F, 0.0F, 3.1416F, 0.0F));

        PartDefinition cube_r25 = RightNonEmmisive.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(28, 6).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(28, 6).addBox(-0.5F, 0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-15.3F, -0.8333F, 0.0F, 0.0F, 3.1416F, 0.0F));

        PartDefinition cube_r26 = RightNonEmmisive.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(28, 6).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(28, 6).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.3F, 0.1667F, 0.0F, 0.0F, 3.1416F, 0.0F));

        PartDefinition RightEmmisives = partdefinition.addOrReplaceChild("RightEmmisives", CubeListBuilder.create().texOffs(0, 263).addBox(-14.9F, -34.8333F, -1.45F, 13.0F, 15.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(16.9F, -18.1667F, -21.15F));

        PartDefinition LeftEmmisives = partdefinition.addOrReplaceChild("LeftEmmisives", CubeListBuilder.create().texOffs(0, 263).addBox(1.9167F, -34.7692F, 0.5167F, 13.0F, 15.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-16.9167F, -18.2308F, -23.1167F));
