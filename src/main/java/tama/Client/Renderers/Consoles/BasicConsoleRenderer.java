...
public class BasicConsoleRenderer<T extends HierarchicalModel<?> & IAnimatableTileModel<ConsoleTile>> extends ConsoleRenderer<ConsoleTile, T> {
    public BasicConsoleRenderer(
