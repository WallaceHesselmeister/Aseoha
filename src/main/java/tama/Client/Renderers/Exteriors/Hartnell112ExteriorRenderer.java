...
import tama.Client.Models.Exteriors.Hartnell112Exterior;
import tama.aseoha;

@OnlyIn(Dist.CLIENT)
public class Hartnell112ExteriorRenderer<
    ...
    public M bakeModel(EntityModelSet set) {
        return (M) new Hartnell112Exterior<T>(set.bakeLayer(Hartnell112Exterior.LAYER_LOCATION));
    }
