...
public class EmoTrait extends Trait {
    ...
    public static final Codec<EmoTrait> CODEC = RecordCodecBuilder.create(i ->
            i.group(
    ...
    public EmoTrait(Codec<? extends Trait> type, List<Pair<ObjectOrTagCodec<Item>, Integer>> likedItems, List<ObjectOrTagCodec<Biome>> likedBiome) {
