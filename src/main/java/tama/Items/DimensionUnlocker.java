...
import net.tardis.mod.helpers.TardisSetupHelper;
...
public class DimensionUnlocker extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41432_, Player p_41433_, InteractionHand p_41434_) {
        Capabilities.getCap(Capabilities.TARDIS, p_41432_).ifPresent(iTardisLevel -> iTardisLevel.getUnlockHandler().unlock(this.DimensionType));
