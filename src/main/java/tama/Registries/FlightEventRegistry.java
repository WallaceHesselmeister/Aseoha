...
public class FlightEventRegistry {
    ...
    public static final RegistryObject<FlightEventType> LOW_ARTRON =
            FLIGHT_EVENTS.register("low_artron", () -> new FlightEventType(1.0F, LowArtronEvent::new));

    public static final RegistryObject<FlightEventType> VORTEX_SCRAP =
            FLIGHT_EVENTS.register("vortex_scrap", () -> new FlightEventType(0.7F, VortexScrapEvent::new));
}
