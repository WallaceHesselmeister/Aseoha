...
import com.code.fabric.entities.*;
...
public class AseohaEntities {
    ...
    public static final RegistrySupplier<EntityType<CybermanEntity>> CYBERMAN;
    ...
    static {
        ...
        LAZER = ENTITY_TYPES.register("lazer", () -> EntityType.Builder.of(com.code.fabric.entities.Lazer::new, MobCategory.MISC).sized(0.1F, 0.1F).build("aseoha:lazer"));
        DALEK = ENTITY_TYPES.register("dalek", () -> EntityType.Builder.of(DalekEntity::new, MobCategory.MONSTER).sized(1F, 2F).build("aseoha:dalek"));
        CYBERMAN = ENTITY_TYPES.register("cyberman", () -> EntityType.Builder.of(CybermanEntity::new, MobCategory.MONSTER).sized(1F, 2F).build("aseoha:cyberman"));
    }
