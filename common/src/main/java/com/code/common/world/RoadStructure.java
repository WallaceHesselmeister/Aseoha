...
import static com.code.common.world.Structures.ROAD_STRUCTURE;

public class RoadStructure extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<RoadStructure> CODEC = RecordCodecBuilder.<RoadStructure>mapCodec(instance ->
            instance.group(RoadStructure.settingsCodec(instance),
            ...
            ).apply(instance, RoadStructure::new)).codec();
    ...
    public RoadStructure(Structure.StructureSettings config,
    ...
    public @NotNull Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (!RoadStructure.extraSpawningChecks(context)) {
        ...
        Optional<Structure.GenerationStub> structurePiecesGenerator =
                JigsawPlacement.addPieces(
                        context, // Used for StructureTemplatePoolBasedGenerator to get all the proper behaviors done.
        ...
        /*
         * Note, you are always free to make your own StructureTemplatePoolBasedGenerator class and implementation of how the structure
    ...
    public @NotNull StructureType<?> type() {
        return ROAD_STRUCTURE.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}